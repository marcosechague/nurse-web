...
<body>
	...
	<main>
	<center>
		   <h5 class="indigo-text">Please enter this information </h5>  
      <div class="section"></div>
		<div class="container">
		<div class="z-depth-1 grey lighten-4 row" style="display: inline-block; padding: 32px 48px 0px 48px; border: 1px solid #EEE;">
			<div class="row">
				<form action="document" method=post class="col s12">
					<div class="row">
						<div class="input-field col s12">
							<input id="document"  name="document" type="text" class="validate"> <label
								for="document">Document number</label>
						</div>
					</div>
