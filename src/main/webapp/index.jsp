...
//     document.getElementById("btn-nurse").innerHTML = "YOU CLICKED ME!";
	        location.href = "patient/step-1";
	    
}
function onClickNurse() {
//  document.getElementById("btn-nurse").innerHTML = "YOU CLICKED ME!";
	        location.href = "nurse/step-1";
...
<!--       <img class="responsive-img" style="width: 250px;" src="https://i.imgur.com/ax0NCsK.gif" /> -->
      ...
      <h4 class="indigo-text">Welcome to Nurse App</h4>
      <h5 class="indigo-text">You are a : </h5>  
      <div class="section"></div>

      <div class="container">
        <div class="z-depth-1 grey lighten-4 row" style="display: inline-block; padding: 32px 48px 0px 48px; border: 1px solid #EEE;">
          <form class="col s12" >
            <a class="waves-effect waves-light btn-large" id="btn-nurse"  onclick="onClickNurse()" >Nurse</a>
            </form>
          <form class="col s12"  >
            <a class="waves-effect waves-light btn-large" id="btn-patient"  onclick="onClickPatient()">Patient</a>
          </form>
        </div>
      </div>
    </center>
